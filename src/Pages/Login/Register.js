                    ...
                    <div className="col">
                        <div className="section-wrapper">
                            ...
                            <form className='register-form' >
                                <input type="text" name="name" id="" placeholder='Username' className='reg-input'/>
                                <input type="email" name="email" id="" placeholder='Email' className='reg-input'/>
                                <input type="password" name="[password]" id="" placeholder='Password' className='reg-input'/>
