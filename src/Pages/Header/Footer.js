...
const socialList = [
    {
        iconName: '<ion-icon name="logo-facebook"></ion-icon>',
        siteLink: '#',
        className: 'facebook',
    },
    {
    ...
    {
        iconName: <ion-icon name="logo-pinterest"></ion-icon>,
        siteLink: '#',
        className: 'pinterest',
    },
]
        ...
        <footer className='style-2'>
            <div className="footer-top dark-view padding-tb">
                <div className="container">
                    <div className="row g-4 row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-1 justify-content-center">
                        <div className="col">
                                            ...
                                            <ul className='lab-ul social-icons'>
                                                {
                                                    socialList.map((val, index) => (
                                                        <li key={index}>
                                                            <Link to='/'><i className='val.iconName'>{val.text}</i></Link>
                                                        </li>
                                                    ))
                                                }
                                            </ul>
            ...
            <div className="footer-bottom">
                <div className="container">
                    <div className="section-wrapper">
                        <p>&copy; 2023 <Link to='#'>Shop Card</Link>Designed By <a href="#" target='_blank'>Parves</a> </p>

                        <div className="footer-bottom-list">
                            {
                                footerBottomList.map((val,i)=>(
                                    <Link to='#' key={i}>{val.text}</Link>
                                ))
                            }
                        </div>
                    </div>
